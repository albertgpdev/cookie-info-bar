...
<div class="cookie-info-bar__content" style="position:absolute; bottom:0px; left:0px; width: 100%;@if(isset($_COOKIE[config('cookie-info-bar.cookie_name')])){{ 'display:none' }}@endif">
